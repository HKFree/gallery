...
it('lets any authenticated user view the private gallery without manage controls', function () {
    Storage::fake('local');
    Storage::disk('local')->put('gallery/ap/13/201/priv/doc.jpg', 'x');
...
it('streams private images only to authenticated users', function () {
    Storage::fake('local');
    Storage::disk('local')->put('gallery/ap/13/201/priv/doc.jpg', 'data');
...
it('does not serve trashed private files', function () {
    Storage::fake('local');
    Storage::disk('local')->put('gallery/ap/13/201/priv/_trashed_x_doc.jpg', 'data');
